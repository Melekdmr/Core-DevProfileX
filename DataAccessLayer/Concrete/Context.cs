...
namespace DataAccessLayer.Concrete
{
...

	{
		protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) // bağlantı adresini tutacak olan metot
		{
			...
			optionsBuilder.UseSqlServer("server=MELEKDMR\\SQLEXPRESS;database=CorePortfolioDB;integrated security=true;TrustServerCertificate=True");
		...
		public DbSet<Annoumcement> Annoumcements { get; set; }
